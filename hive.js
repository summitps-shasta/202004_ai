...
bot.direction = function(game) {
    ...
    // how many steps to my hive?
    var stepsToBase = bot.findDistance(game.myBot.pos, game.myBase.pos);
    // how many turns left to end a game?
    var turnsLeft = game.totalTurns - game.turn;
    
    // find the position of flowers, which one has the most pollen?
    ...
    // does my bee have a lot of pollen already, go to my hive.
    if (game.myBot.pollen >= 200) {
        task = "myBase";
    }
    // is game about to end, go to my hive.
